  ...
  <body>
    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-sm-7 text-center pt-2 mt-5">
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" name="myForm2"  method="POST" enctype="multipart/form-data">
                    ...
                    <p id="p1">CHOOSE ANY OPTION FOR YOUR NIKE LIBRARY</p>
                    <!-- <p class="p2">Choose any Option</p> -->
                    ...
                    <input class="but" name="submit" type="submit" value="Add Products" id="mainButt">
                    
                    
                    <input class="but" name="submit2" type="submit" value="Update Products" id="mainButt2">
                    
                    
                    <input class="but" name="submit3" type="submit" value="Delete Products" id="mainButt3">
                    <br>
